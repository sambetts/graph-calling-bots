...
public class RickrollPstnBot : PstnCallingBot<BaseActiveCallState>
{
    ...
    /// </summary>
    public RickrollPstnBot(SingleWavFileBotConfig botOptions, BotCallRedirector<BaseGraphCallingBot<BaseActiveCallState>, BaseActiveCallState> botCallRedirector, ILogger<RickrollPstnBot> logger, ICallStateManager<BaseActiveCallState> callStateManager,
