...
public class RickrollPstnBot : PstnCallingBot
{
    ...
    /// </summary>
    public RickrollPstnBot(RemoteMediaCallingBotConfiguration botOptions, ILogger logger, ICallStateManager callStateManager) : base(botOptions, callStateManager, logger)
    {
